...
namespace WindowsFormsApplication1
{
    ...
    public partial class MainWin : Form
    {
        ...
        private void InitRectangle(TDftAlgorithm dft)
        {
            ...
            dft.y[0].real = 0.0;
            dft.y[0].imag = 0.0;
            dft.y[order/2].real = 0.0;
            dft.y[order/2].imag = 0.0;
            dft.y[order].real = 0.0;
            dft.y[order].imag = 0.0;
        }
        ...
        private void InitSaw(TDftAlgorithm dft)
        {
            ...
            for (j = 0; j < (order / 2); j++)
            {
                ...
                dft.y[j].imag = 0.0;
                dft.y[j + (order / 2) + 1].real = -(double)(500 - j) * 20.0 / (double)(order/2);
                dft.y[j + (order / 2) + 1].imag = 0.0;
            }
            dft.y[0].real = 0.0;
            dft.y[0].imag = 0.0;
