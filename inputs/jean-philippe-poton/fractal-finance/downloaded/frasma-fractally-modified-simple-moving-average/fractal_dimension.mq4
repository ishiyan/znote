...
void _computeLastNbBars( int lastBars )
  {
   ...
   switch( e_type_data )
     {
      case PRICE_CLOSE    : ArrayCopy(tmpArray,Close,0,0,WHOLE_ARRAY); _computeFdi( lastBars,tmpArray); break;
      case PRICE_OPEN     : ArrayCopy(tmpArray,Open,0,0,WHOLE_ARRAY);  _computeFdi( lastBars,tmpArray); break;
      case PRICE_HIGH     : ArrayCopy(tmpArray,High,0,0,WHOLE_ARRAY);  _computeFdi( lastBars,tmpArray); break;
      case PRICE_LOW      : ArrayCopy(tmpArray,Low,0,0,WHOLE_ARRAY);   _computeFdi( lastBars,tmpArray); break;
      case PRICE_MEDIAN   :
