...
| `PIP_Convertor` | int | 10000 | $> 0$ | Multiplier to convert prices to PIPs |
...
```mermaid
flowchart TD
    A[Input: price array, period, normal_speed, PIP_Convertor] --> B[For each bar pos]
...
| `PIP_Convertor` | Price-to-PIPs multiplier |
