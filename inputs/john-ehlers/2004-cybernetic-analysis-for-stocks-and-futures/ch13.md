...
![Figure 13.1 - Transfer Response of the Regularized Filter (alpha = 0.33, lambda = 10)](assets/fig13-1.png)

**Figure 13.1** *Transfer Response of the Regularized Filter (alpha = 0.33, lambda = 10)*
...
For example, if $\alpha = 0.33$, then the ideal value of lambda is 1.624. The filter transfer response for this pair of parameters is shown in Figure 13.2. The frequency response is almost flat from zero frequency to 0.05 cycles per day. From that point on, the higher-frequency components are increasingly attenuated.

![Figure 13.2 - Transfer Response of the Regularized Filter (alpha = 0.33, lambda = 1.624)](assets/fig13-2.png)

**Figure 13.2** *Transfer Response of the Regularized Filter (alpha = 0.33, lambda = 1.624)*
...
![Figure 13.3 - Lag Response of the Regularized Filter (alpha = 0.33, lambda = 1.624)](assets/fig13-3.png)

**Figure 13.3** *Lag Response of the Regularized Filter (alpha = 0.33, lambda = 1.624)*

Recalling from Chapter 2 that the transfer response of an exponential moving average is expressed as

$$H(Z) = \frac{Output}{Input} = \frac{\alpha}{1 - (1 - \alpha) \cdot Z^{-1}} \tag{13.8}$$
...
$$H(Z) = \frac{Output}{Input} = \frac{\frac{1}{1 + \lambda}}{1 - \frac{1 - \alpha + 2\lambda}{1 + \lambda} Z^{-1} + \frac{\lambda}{1 + \lambda} Z^{-2}} \tag{13.9}$$
...
![Figure 13.10 - Transfer Response of the Two-Pole Super Smoother Filter](assets/fig13-10.png)

**Figure 13.10** *Transfer Response of the Two-Pole Super Smoother Filter*
...
![Figure 13.13 - Transfer Response of a Three-Pole Super Smoother Filter](assets/fig13-13.png)

**Figure 13.13** *Transfer Response of a Three-Pole Super Smoother Filter*
