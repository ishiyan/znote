...
![Figure 14.1 - Schematic of a Moving Average](assets/fig14-1.png)

**Figure 14.1** *Schematic of a Moving Average*
...
![Figure 14.2 - Schematic of a Four-Element FIR Filter](assets/fig14-2.png)

**Figure 14.2** *Schematic of a Four-Element FIR Filter*
...
![Figure 14.3 - All-Pass Network Lag Is a Function of Frequency and Damping Factor](assets/fig14-3.png)

**Figure 14.3** *All-Pass Network Lag Is a Function of Frequency and Damping Factor*
...
![Figure 14.4 - Schematic of a Laguerre Filter](assets/fig14-4.png)

**Figure 14.4** *Schematic of a Laguerre Filter*
...
**Figure 14.6** *EFS Code*

![Figure 14.7 - Four-Element Laguerre Filter Is Dramatically Smoother than a Conventional Four-Element FIR Filter](assets/fig14-7.png)

**Figure 14.7** *Four-Element Laguerre Filter Is Dramatically Smoother than a Conventional Four-Element FIR Filter*
...
$$RSI = 100 - \frac{100}{1 + \frac{CU}{CD}}$$

$$RSI = 100 - \frac{100\times CD}{CU + CD}$$

$$RSI = \frac{100\times CU + 100\times CD - 100\times CD}{CU + CD}$$
...
**Figure 14.9** *EFS Code*

![Figure 14.10 - A Laguerre RSI Reacts Rapidly to Price Changes](assets/fig14-10.png)

**Figure 14.10** *A Laguerre RSI Reacts Rapidly to Price Changes*
