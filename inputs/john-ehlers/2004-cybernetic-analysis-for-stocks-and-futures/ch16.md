...
![Figure 16.1 - How Leading Indicators Are Constructed](assets/fig16-1.png)
...
$$(J - k) = \alpha * J + (1 - \alpha) * (J - 1 - k)\tag{16.1}$$
...
$$\begin{aligned}
H(z) = \frac{Output}{Input} &= 2 - \frac{\alpha * Z^{-1}}{1 - (1 - \alpha) * Z^{-1}} \\[1ex]
&= \frac{2 + (\alpha - 2) * Z^{-1}}{1 - (1 - \alpha) * Z^{-1}}
\end{aligned}\tag{16.4}$$
...
![Figure 16.2 - Noise Gain of a Leading Indicator](assets/fig16-2.png)
...
![Figure 16.3 - Net Gain of a Leading Indicator](assets/fig16-3.png)

**Figure 16.3** *Net Gain of a Leading Indicator*

![Figure 16.4 - The Net Filter Has a Low-Frequency Leading Characteristic](assets/fig16-4.png)
...
![Figure 16.7 - Leading Indicator (alpha1 = 0.25, alpha2 = 0.33) and EMA](assets/fig16-7.png)

**Figure 16.7** *Leading Indicator (alpha1 = 0.25, alpha2 = 0.33) and EMA*

![Figure 16.8 - Leading Indicator (alpha1 = 0.15, alpha2 = 0.33) and EMA Provides a Clearer Picture of the Trend Continuation](assets/fig16-8.png)

**Figure 16.8** *Leading Indicator (alpha1 = 0.15, alpha2 = 0.33) and EMA Provides a Clearer Picture of the Trend Continuation*
