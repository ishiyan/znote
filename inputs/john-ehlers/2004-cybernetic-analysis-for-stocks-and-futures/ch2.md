...
![Figure 2.1 - EMA Frequency Response (alpha = 0.05)](assets/fig2-1.png)
...
![Figure 2.2 - Smoothed-Input EMA Frequency Response (alpha = 0.05)](assets/fig2-2.png)
...
![Figure 2.3 - Smoothed-Input Lag Response (alpha = 0.05)](assets/fig2-3.png)
...
![Figure 2.4 - Transfer Response of Second-Order High-Pass Gaussian Filter (alpha = 0.05)](assets/fig2-4.png)
...
![Figure 2.5 - Frequency Response of the Instantaneous Trendline Filter (alpha = 0.05)](assets/fig2-5.png)
...
![Figure 2.6 - Lag of the Instantaneous Trendline Filter (alpha = 0.05)](assets/fig2-6.png)
...
![Figure 2.7 - Instantaneous Trendline Has Much Less Lag than an EMA (alpha = 0.05)](assets/fig2-7.png)
