...
![Figure 9.1 - A Phasor Can Represent a Cycle](assets/fig9-1.png)

**Figure 9.1** *A Phasor Can Represent a Cycle*
...
![Figure 9.2 - The Phase Angle Is the Arctangent of the Ratio of the Quadrature and InPhase Components](assets/fig9-2.png)

**Figure 9.2** *The Phase Angle Is the Arctangent of the Ratio of the Quadrature and InPhase Components*
...
$$Q = 0.0962 \times Price + 0.5769 \times Price[2] - 0.5769 \times Price[4] - 0.0962 \times Price[6]\tag{9.1}$$
...
![Figure 9.3 - The Hilbert Transform Enables Rapid Measurement of the Cycle Period](assets/fig9-3.png)

**Figure 9.3** *The Hilbert Transform Enables Rapid Measurement of the Cycle Period*
...
$$\arctan(A) - \arctan(B) = \arctan\left(\frac{A - B}{1 + AB}\right)\tag{9.3}$$
...
![Figure 9.6 - Measurement of a Single 20-Bar Cycle](assets/fig9-6.png)

**Figure 9.6** *Measurement of a Single 20-Bar Cycle*
...
![Figure 9.7 - Measurement of a Chirped Waveform Whose Period Increases from 6 Bars to 40 Bars](assets/fig9-7.png)

^^Figure 9.7** *Measurement of a Chirped Waveform Whose Period Increases from 6 Bars to 40 Bars*
...
![Figure 9.8 - Measurement of Cycle Periods Varying from 30-Bar Cycles to 15-Bar Cycles and Back](assets/fig9-8.png)

**Figure 9.8** *Measurement of Cycle Periods Varying from 30-Bar Cycles to 15-Bar Cycles and Back*
...
![Figure 9.9 - Cycle Measurement of Real Data](assets/fig9-9.png)

**Figure 9.9** *Cycle Measurement of Real Data*
