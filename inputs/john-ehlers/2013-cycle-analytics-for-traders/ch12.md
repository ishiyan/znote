...
![Figure 12.1: The Default Even Better Sinewave Indicator Holds a Position](assets/ch12_fig_01.png)
...
![Figure 12.2: Trade Position Length is Increased by Increasing the](assets/ch12_fig_02.png)

**Figure 12.2** *Trade Position Length is Increased by Increasing the Duration Input Parameter*

![Figure 12.3: Decreasing the Duration Input Parameter Make the Even](assets/ch12_fig_03.png)
