...
![Figure 8.1: Random Numbers with Memory Produce Reasonable](assets/ch8_fig_01.png)
...
![Figure 8.2: Autocorrelation Indicator Shows Correlation to Itself Over a](assets/ch8_fig_02.png)

**Figure 8.2** *Autocorrelation Indicator Shows Correlation to Itself Over a Range of Lag Periods^

![Figure 8.3: Autocorrelation Indicator with an Averaging Period of Three](assets/ch8_fig_03.png)
...
![Figure 8.4: Autocorrelation of a Theoretical 20-Bar Sine Wave](assets/ch8_fig_04.png)
...
![Figure 8.5: Autocorrelation Periodogram for DG](assets/ch8_fig_05.png)
...
![Figure 8.6: The Number of Indicated Reversals Is Decreased by Increasing](assets/ch8_fig_06.png)
