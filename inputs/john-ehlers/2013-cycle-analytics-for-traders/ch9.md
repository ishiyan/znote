...
![Figure 9.1: An Example of a DFT Spectral Estimate](assets/ch9_fig_01.png)

**Figure 9.1** *An Example of a DFT Spectral Estimate*

![Figure 9.2: DFT Spectral Estimate Compares Favorably with an](assets/ch9_fig_02.png)
