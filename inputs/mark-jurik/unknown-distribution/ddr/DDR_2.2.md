...
@manual{jurik_ddr_22,
  ...
  year         = {2001},
  note         = {From unknown-distribution archive}
}
```
...
2. Get your access PASSWORD from Jurik Research Software. Call 720-here (USA), fax 720-here (USA), e-mail support@jurikres.com, or write Jurik Research Software at PO 460669, Aurora, CO 80046. Be sure to give your full name, mailing address and computer identification number. You will then be given a password.
...
![DDR axis rotation — X-Y coordinates replacing P-C coordinates to reduce dimensions](images/figure_time_series.png)
