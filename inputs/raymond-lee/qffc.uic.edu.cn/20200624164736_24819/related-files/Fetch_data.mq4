...
string      QP_Directory   = "Indicator";       // data Directory
...
int read_data(string TPSymbol, double &return_array[]){
      ...
      string Data_FileName = "D_"+TPSymbol+".csv";
      ...
      // Write Header Line
      FileWrite(QPD_FileHandle,"Year","Month","Day","Open","High","Low","Close","Volumn","Return","MA","RSI","MACDM","MACDS",
                                 "QPL1","QPL2","QPL3","QPL4","QPL5","QPL6","QPL7","QPL8","QPL9","QPL10","QPL11","0",
                                 "QPL-1","QPL-2","QPL-3","QPL-4","QPL-5","QPL-6","QPL-7","QPL-8","QPL-9","QPL-10","QPL-11");
      //FileWrite(QPD_FileHandle,"Year","Month","Day","Open","High","Low","Close","Volumn","Return","QPL1","QPL2","QPL3","QPL4","QPL5",
      //                           "QPL6","QPL7","QPL8","QPL9","QPL10","QPL11","QPL12","QPL13","QPL14","QPL15","QPL16","QPL17","QPL18","QPL19","QPL20","QPL21",
      //                           "QPL-1","QPL-2","QPL-3","QPL-4","QPL-5","QPL-6","QPL-7","QPL-8","QPL-9","QPL-10","QPL-11","QPL-12",
      //                           "QPL-13","QPL-14","QPL-15","QPL-16","QPL-17","QPL-18","QPL-19","QPL-20","QPL-21");
      ...
      //generate energy level and dump into csv
         double QPLn1,QPLn2,QPLn3,QPLn4,QPLn5,QPLn6,QPLn7,QPLn8,QPLn9,QPLn10,QPLn11,QPLn12,QPLn13,QPLn14,QPLn15,QPLn16,QPLn17,QPLn18,QPLn19,QPLn20,QPLn21;
         ...
         FileWrite(QPD_FileHandle,DT_YY[d-1],DT_MM[d-1],DT_DD[d-1],
             ...
             DT_VL[d], DoubleToString(DT_RT[d-1],8),DoubleToString(DT_MA[d-1],8),DoubleToString(DT_RSI[d-1],8),
             DoubleToString(DT_MACDM[d-1],8),DoubleToString(DT_MACDS[d-1],8),
             //DoubleToString(QPL1,8),
             DoubleToString(QPL2,8),DoubleToString(QPL3,8),DoubleToString(QPL4,8),
             DoubleToString(QPL5,8),DoubleToString(QPL6,8),DoubleToString(QPL7,8),DoubleToString(QPL8,8),
             DoubleToString(QPL9,8),DoubleToString(QPL10,8),DoubleToString(QPL11,8),DoubleToString(QPL12,8),
             // for the no action 
             0,
             //DoubleToString(QPL13,8),DoubleToString(QPL14,8),DoubleToString(QPL15,8),DoubleToString(QPL16,8),
             //DoubleToString(QPL17,8),DoubleToString(QPL18,8),DoubleToString(QPL19,8),DoubleToString(QPL20,8),DoubleToString(QPL21,8),DoubleToString(QPLn1,8),
             ...
             //DoubleToString(QPLn13,8),DoubleToString(QPLn14,8),DoubleToString(QPLn15,8),DoubleToString(QPLn16,8),
             //DoubleToString(QPLn17,8),DoubleToString(QPLn18,8),DoubleToString(QPLn19,8),DoubleToString(QPLn20,8),DoubleToString(QPLn21,8)
             );
      }     
