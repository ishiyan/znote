...
#property indicator_buffers 14             // number of buffers used
...
double HHLLBuffer[];      // Price range (q bars)
...
//--- starting plot index for graphic plot #0
   PlotIndexSetInteger(0,PLOT_DRAW_BEGIN,begin4);
//--- starting plot index for graphic plot #1
...
//--- indicator short name
   ...
   IndicatorSetString(INDICATOR_SHORTNAME,"Blau_Ergodic_CSI("+shortname+")");
//--- OnInit done
   return(0);
  }
//+------------------------------------------------------------------+
...
int OnCalculate(
                ...
                const int prev_calculated, // number of bars, caluclated at previous call
...
//--- EMA smoothing
   ...
   ExponentialMAOnBufferWB(
                           rates_total,     // rates total
                           prev_calculated, // number of bars, caluclated at previous call
